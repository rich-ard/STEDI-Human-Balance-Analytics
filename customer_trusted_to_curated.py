...
AmazonS3_node1737326290613 = glueContext.getSink(path="s3://frequently-modulated/customer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1737326290613")
