...
AmazonS3_node1737397471428 = glueContext.getSink(path="s3://frequently-modulated/machine_learning_curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1737397471428")
