...
StepTrainerTrusted_node1737394519233 = glueContext.getSink(path="s3://frequently-modulated/step_trainer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="StepTrainerTrusted_node1737394519233")
